...
echo "The current configuration supports LSP for Lua, Python, Go, Nash and PHP, they will be configured by default."
echo -e "The lsp in questions are lua_ls, pylsp, gopls, bashls, phpactor. You need them in your path before using them."
echo -e "The current configuration supports formatting for Lua, Python, Go, Bash and PHP.\nTo use these, install them in your path and use :Meson to configure them for neovim.\nLua: stylua\nPython: black, isort\nGo: gofumpt, golines, goimports_reviser\nBash: shellharden\nPHP: phpcsfixer"
echo -e "The current configuration supports linting for Go, Python, Bash and PHP.\nTo use these, install them in your path and use :Meson to configure them for neovim.\nGo: golangci-lint\nPython: pylint\nBash: shellcheck\nPHP: phpcs"
